( function( $ ){
    ...
    var $backgrounds = $( "<ul class='sm-slider'></ul>" ),
        ...
        init : function( settings ) {
            var options = {
                src:        [
                                {url:"../images/piza_1920.jpg",title:"ピザ"},
                                {url:"../images/tee_1920.jpg",title:"Tee"},
                                {url:"../images/tomato_1920.jpg",title:"とまと"}],
                scaling:    1.17,
                rotating:   3,
                duration:   6,
                fade:       2,
        ...
        mkcss: function( bgCount , duration , fade  ) 
        {
            ...
            otherCSS = ".sm-slider,.sm-slider:after { margin: 0;padding: 0;list-style: none;position: fixed;width: 100%;height: 100%;top: 0px;left: 0px;z-index: -1; }.sm-slider:after { content: '';background: transparent url({0}) repeat top left;z-index: 0; }.sm-slider li span { width: 100%;height: 100%;position: absolute;top: 0px;left: 0px;color: transparent;background-size: cover;background-position: 50% 50%;background-repeat: no-repeat;opacity: 0;z-index: 0;animation: imageAnimation {1}s linear infinite 0s; }.sm-slider li div { z-index: 1000;position: absolute;bottom: 30px;left: 0px;width: 100%;text-align: center;opacity: 0;color: #fff;animation: titleAnimation {1}s linear infinite 0s; }".format(this.options.overlay,total_time),
