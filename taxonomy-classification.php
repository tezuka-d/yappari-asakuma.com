 ...
 */
$post_type = get_post_type_object( 'exhibits' );
$termname = single_term_title('',false);
$terms = get_term_by( 'name', $termname, 'classification', OBJECT);
...
<div class="row1">
<p class="CatTitle" id="CatExhibits"><span><?php echo $terms->name; ?></span></p>
</div>
</div>
</section>
