 ...
 */
$post_type = get_post_type_object( 'exhibits_en' );
$termname = single_term_title('',false);
$terms = get_term_by( 'name', $termname, 'class_en', OBJECT);
$pg_args["class"] = "Exhibits";
...
<div class="row1">
<p class="CatTitle en" id="CatExhibits"><span><?php echo $terms->name; ?></span></p>
</div>
</div>
</section>
...
while(have_posts()):the_post();
	$terms = get_the_terms( $post->ID, 'class_en' );
	$i++;
	if ($i%2 == 0) {
		$class = "gray242";
	} else {
...
<?php get_template_part('enrtybody-en');?>
